...
public class APIException extends RuntimeException {
	...
	public static APIException dadosDuplicados(String message, ProblemType problemType) {
		return new APIException(HttpStatus.BAD_REQUEST, message, problemType);
	}
	public static APIException negocio(String message, ProblemType problemType) {
		return new APIException(HttpStatus.UNPROCESSABLE_ENTITY, message, problemType);
	}
